...
function AppContent() {
  ...
  const hideNavbarFooterRoutes = [
    ...
    '/admin/dashboard', '/admin/users', '/admin/registered-patients', '/admin/doctors', '/admin/doctor-schedules', '/admin/schedule-requests', '/admin/patients', '/admin/family-members', '/admin/payments', '/admin/messages', '/admin/departments', '/admin/leave-requests', '/admin/feedback', '/admin/appointments', '/admin/reports', '/admin/logs', '/admin/doctor-load', '/admin/priority', '/admin/ml',
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1">
        <Routes>
          ...
          <Route path="/medical-records" element={<ProtectedRoute requiredRole="patient"><MedicalRecords /></ProtectedRoute>} />
          ...
          <Route path="/admin/ml" element={<ProtectedRoute requiredRole="admin"><AdminDashboard /></ProtectedRoute>} />
          ...
          <Route path="/doctor/earnings" element={<ProtectedRoute requiredRole="doctor"><DoctorEarningsPage /></ProtectedRoute>} />
