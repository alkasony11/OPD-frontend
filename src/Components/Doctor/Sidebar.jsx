...
export default function DoctorSidebar() {
  ...
  const menuItems = [
    ...
    { name: 'Earnings', icon: HiCurrencyRupee, path: '/doctor/earnings' },
  ...
  return (
    <div className={`bg-blue-900 text-white h-screen fixed left-0 top-0 z-50 transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'
      }`}>
      {/* Header */}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-blue-700">
        ...
        <button
          ...
          className={`flex items-center space-x-3 w-full px-3 py-2 text-blue-200 hover:bg-red-600 hover:text-white rounded-lg transition-colors ${isCollapsed ? 'justify-center' : ''
            }`}
